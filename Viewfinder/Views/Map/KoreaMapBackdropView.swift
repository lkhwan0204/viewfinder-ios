...
private enum ViewfinderMapMarkerIcon {
    static let normal: NMFOverlayImage = makeOverlayImage(
        ...
        fillColor: AppColors.uiPrimary,
        strokeColor: UIColor.white,
        centerColor: UIColor.white,
        reuseIdentifier: "photo-shoot-marker-primary-v3"
    )

    static let preview: NMFOverlayImage = makeOverlayImage(
        size: CGSize(width: 42, height: 54),
        fillColor: AppColors.uiAccent,
        strokeColor: UIColor.white,
        centerColor: UIColor.white,
        reuseIdentifier: "photo-shoot-marker-preview-accent-v2"
    )
    ...
    static let saved: NMFOverlayImage = makeOverlayImage(
        ...
        strokeColor: UIColor.white,
        centerColor: UIColor.white,
        reuseIdentifier: "photo-shoot-marker-saved-accent-v3"
    )
