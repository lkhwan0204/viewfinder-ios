...
private struct SearchFullScreenView: View {
    ...
    @StateObject private var locationReader = SearchRecommendationLocationReader()
...
@MainActor
private final class SearchRecommendationLocationReader: NSObject, ObservableObject, CLLocationManagerDelegate {
